...
<?php
    ...
    if ($theme == 'dark'){
      $backgroundCol = '#38222a9e';
    }
    else{
      $backgroundCol = '#df9cc6ac';
    }
  ?>
...
<body>
  ...
  background-color: <?php $backgroundCol ?>;
}
.navbar {
  overflow: hidden;
  top: 0;
...
<!-- THE CARS GALLERY -->
  ...
  <h2>Wide range of JDM car models for sale</h2>
      ...
      {
        echo
      "<button id= 'saveFilter' onclick = 'saveFilter()' >Save filter</button>";
      }
      ?>
      ...
      {
        echo "<script type = 'text/javascript' src = 'js/code_no_login.js'></script>";
      }
    ?>
